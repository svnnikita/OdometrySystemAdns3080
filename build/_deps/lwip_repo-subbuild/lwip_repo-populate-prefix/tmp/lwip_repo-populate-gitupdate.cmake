...
execute_process(
  COMMAND "/usr/bin/git" show-ref "STABLE-2_2_0_RELEASE"
  WORKING_DIRECTORY "/home/nikita/MACHINE/freertos-proj/build/_deps/lwip_repo-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "STABLE-2_2_0_RELEASE")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("STABLE-2_2_0_RELEASE" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/STABLE-2_2_0_RELEASE")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nikita/MACHINE/freertos-proj/build/_deps/lwip_repo-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nikita/MACHINE/freertos-proj/build/_deps/lwip_repo-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
