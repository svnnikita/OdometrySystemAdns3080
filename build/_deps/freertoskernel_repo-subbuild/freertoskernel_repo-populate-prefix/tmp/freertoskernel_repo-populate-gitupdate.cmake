...
execute_process(
  COMMAND "/usr/bin/git" show-ref "V11.1.0"
  WORKING_DIRECTORY "/home/nikita/MACHINE/freertos-proj/build/_deps/freertoskernel_repo-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nikita/MACHINE/freertos-proj/build/_deps/freertoskernel_repo-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nikita/MACHINE/freertos-proj/build/_deps/freertoskernel_repo-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
